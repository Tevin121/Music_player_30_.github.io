...
- Using an ERROR-Check to verify one dimension when the other dimension creates the referent
- Reading an Array by counting by 1's
- Building a group of formulae to populate the array with local variables

- Recognizing patterns and repetitions within array formulae

v2
- ERROR-Check: using println(statements) to inspect and track variables
- Using If-ElseIf-Else Structures to summarize Array Group of Formulae
- Identifying Sections of Counted-groups-of-4 with Conditionals, Shortcuts, and casting int(float-division)
